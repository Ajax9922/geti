            ...
            "augmentation": {
                "random_resize_crop": [
                    {
                        ...
                        "type": "bool",
                        "description": "Whether to apply random resize and crop to the image. Note: this augmentation is not supported when Tiling algorithm is enabled.",
                        "value": True,
                        "default_value": True,
                    },
                    {
                        ...
                        "type": "array",
                        "description": "Range (min, max) of crop ratios to apply during resize crop operation. Specifies the fraction of the original image dimensions to retain after cropping. For example, (0.8, 1.0) will randomly crop between 80% and 100% of the original size. Both values should be between 0.0 and 1.0.",
                        "value": [0.08, 1.0],
                    ...
                    },
                    {
                        ...
                        "type": "array",
                        "description": "Range (min, max) of aspect ratios to apply during resize crop operation. Aspect ratio is defined as width divided by height. For example, (0.75, 1.33) allows the crop to have an aspect ratio between 3:4 and 4:3.",
                        "value": [0.75, 1.34],
                ...
                "random_affine": [
                    ...
                    },
                    {
                        ...
                        "type": "float",
                        "description": "Maximum rotation angle in degrees for affine transformation. A random angle in the range [-max_rotate_degree, max_rotate_degree] will be applied. For example, max_rotate_degree=10 allows up to ±10 degrees rotation.",
                        "value": 10.0,
                        "default_value": 10.0,
                        "min_value": 0.0,
                        "max_value": None,
                    },
                    {
                        ...
                        "type": "float",
                        "description": "Maximum translation as a fraction of image width or height. A random translation in the range [-max_translate_ratio, max_translate_ratio] will be applied along both axes. For example, 0.1 allows up to ±10% translation.",
                        "value": 0.1,
                        "default_value": 0.1,
                        "min_value": 0.0,
                        "max_value": 1.0,
                    },
                    {
                        ...
                        "type": "array",
                        "description": "Range (min, max) of scaling factors to apply during affine transformation. Both values should be > 0.0. For example, (0.8, 1.2) will randomly scale the image between 80% and 120% of its original size.",
                        "value": [0.5, 1.5],
                    ...
                    },
                    {
                        ...
                        "type": "float",
                        "description": "Maximum absolute shear angle in degrees to apply during affine transformation. A random shear in the range [-max_shear_degree, max_shear_degree] will be applied.",
                        "value": 2.0,
                        "default_value": 2.0,
                        "min_value": None,
                        "max_value": None,
                ...
                "random_horizontal_flip": [
                    ...
                    },
                    {
                        ...
                        "name": "Probability",
                        "type": "float",
                        "description": "Probability of applying horizontal flip. A value of 0.5 means each image has a 50% chance to be flipped horizontally.",
                        "value": 0.5,
                        "default_value": 0.5,
                        "min_value": 0.0,
                        "max_value": 1.0,
                ...
                "random_vertical_flip": [
                    ...
                    },
                    {
                        ...
                        "name": "Probability",
                        "type": "float",
                        "description": "Probability of applying vertical flip. A value of 0.5 means each image has a 50% chance to be flipped vertically.",
                        "value": 0.5,
                        "default_value": 0.5,
                        "min_value": 0.0,
                        "max_value": 1.0,
                ...
                "color_jitter": [
                    ...
                    },
                    {
                        ...
                        "type": "array",
                        "description": "Range (min, max) of brightness adjustment factors. A random factor from this range will be multiplied with the image brightness. For example, (0.8, 1.2) means brightness can be reduced by 20% or increased by 20%.",
                        "value": [0.875, 1.125],
                    ...
                    },
                    {
                        ...
                        "name": "Contrast range",
                        "type": "array",
                        "description": "Range (min, max) of contrast adjustment factors. A random factor from this range will be multiplied with the image contrast. For example, (0.5, 1.5) means contrast can be halved or increased by up to 50%.",
                        "value": [0.5, 1.5],
                        "default_value": [0.5, 1.5],
                    },
                    {
                        ...
                        "type": "array",
                        "description": "Range (min, max) of saturation adjustment factors. A random factor from this range will be multiplied with the image saturation. For example, (0.5, 1.5) means saturation can be halved or increased by up to 50%.",
                        "value": [0.5, 1.5],
                        "default_value": [0.5, 1.5],
                    },
                    {
                        ...
                        "name": "Hue range",
                        "type": "array",
                        "description": "Range (min, max) of hue adjustment values. A random value from this range will be added to the image hue. For example, (-0.05, 0.05) means hue can be shifted by up to ±0.05.",
                        "value": [-0.05, 0.05],
                    ...
                    },
                    {
                        ...
                        "name": "Probability",
                        "type": "float",
                        "description": "Probability of applying color jitter. A value of 0.5 means each image has a 50% chance to be color jittered.",
                        "value": 0.5,
                        "default_value": 0.5,
                        "min_value": 0.0,
                        "max_value": 1.0,
                ...
                "gaussian_blur": [
                    ...
                    },
                    {
                        ...
                        "name": "Kernel size",
                        "type": "int",
                        "description": "Size of the Gaussian kernel. Larger kernel sizes result in stronger blurring. Must be a positive odd integer.",
                        "value": 5,
                        "default_value": 5,
                        "min_value": 0,
                        "max_value": None,
                    },
                    {
                        ...
                        "name": "Sigma range",
                        "type": "array",
                        "description": "Range (min, max) of sigma values for Gaussian blur. Sigma controls the amount of blurring. A random value from this range will be used for each image.",
                        "value": [0.1, 2.0],
                    ...
                    },
                    {
                        ...
                        "name": "Probability",
                        "type": "float",
                        "description": "Probability of applying Gaussian blur. A value of 0.5 means each image has a 50% chance to be blurred.",
                        "value": 0.5,
                        "default_value": 0.5,
                        "min_value": 0.0,
                        "max_value": 1.0,
                ...
                "gaussian_noise": [
                    ...
                    },
                    {
                        ...
                        "type": "float",
                        "description": "Standard deviation of the Gaussian noise. Controls the intensity of the noise. Higher values result in noisier images.",
                        "value": 0.1,
                        "default_value": 0.1,
                        "min_value": 0.0,
                        "max_value": None,
                    },
                    {
                        ...
                        "name": "Probability",
                        "type": "float",
                        "description": "Probability of applying Gaussian noise. A value of 0.5 means each image has a 50% chance to have noise added.",
                        "value": 0.5,
                        "default_value": 0.5,
                        "min_value": 0.0,
                        "max_value": 1.0,
