...
export const RemoveFromWorkspaceDialog = ({
  ...
  return (
    ...
    >
      <span>
        "{user.email}" will be removed from "{workspaceName}". Before removing the user, please make sure that the
        user is added to another workspace so that they can still access your Geti organization. You can add the user
        back to this workspace at any time.
        <br />
        <br />
