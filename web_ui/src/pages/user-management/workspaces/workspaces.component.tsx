...
export const Workspaces = () => {
    ...
    return (
        <Flex direction={'column'} height={'100%'} gap={'size-300'}>
            <Text>
                Manage the workspaces that you have access to as part of your organization. Workspace admins can view and
                manage all projects inside a workspace, and can add users from the organization to their workspace.
